...
<section  class="bg-center bg-no-repeat bg-gray-700 bg-blend-multiply"
          style="background-image: url('img/dorvenica1.jpeg'); height: 700px">
<!-- class="bg-center bg-no-repeat bg-[url('')] bg-gray-700 bg-blend-multiply"> -->
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
      ...
      <!-- <div 
         class="sm:bg-cover md:bg-content lg:bg-auto xl:bg-cover bg-auto bg-center"
          style="background-image: url('img/dorvenica1.jpeg'); height: 700px">
      </div>	        -->
     </v-row>
  </v-container> 
  ...
  <style scoped>
  .image{
    background: url('/img/dorvenica1.jpeg') no-repeat ;
